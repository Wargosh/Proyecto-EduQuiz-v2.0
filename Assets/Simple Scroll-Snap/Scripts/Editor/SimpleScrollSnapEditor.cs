...
namespace DanielLochner.Assets.SimpleScrollSnap
{
    ...
    {
        #region Fields
        private int numberOfPanels, selectedProperty;
        ...
        private SerializedProperty movementType, movementAxis, automaticallyLayout, sizeControl, size, automaticLayoutSpacing, leftMargin, rightMargin, topMargin, bottomMargin, infinitelyScroll, automaticScroll, infiniteScrollingEndSpacing, startingPanel, swipeGestures, thresholdSwipeSpeed, previousButton, nextButton, pagination, toggleNavigation, snapTarget, snappingSpeed, thresholdSnappingSpeed, hardSnap, onPanelSelecting, onPanelSelected, onPanelChanging, onPanelChanged;
        ...
        private void OnEnable()
        {
            ...
            numberOfPanels = simpleScrollSnap.Content.childCount;
            ...
            automaticScroll = serializedObject.FindProperty("automaticScroll");
            ...
            thresholdSwipeSpeed = serializedObject.FindProperty("thresholdSwipeSpeed");
        ...
        private void HeaderInformation()
        {
            ...
            GUILayout.Label("Version: 1.1.2", new GUIStyle() { fontSize = 14, alignment = TextAnchor.MiddleCenter });
        ...
        private void AutomaticScrolling()
        {
            EditorGUILayout.PropertyField(automaticScroll, new GUIContent("Automatic Scrolling", "Should panels wrap around to the opposite end once passed, giving the illusion of an infinite list of elements?"));
        ...
        private void SwipeGestures()
        {
            ...
            {
                EditorGUI.indentLevel++;
                EditorGUILayout.PropertyField(thresholdSwipeSpeed, new GUIContent("Threshold Swipe Speed", "The speed at which the user must be swiping in order for a transition to occur to another panel."));
                EditorGUI.indentLevel--;
            }
        }
        ...
        private void Pagination()
        {
            ...
            if (simpleScrollSnap.pagination != null)
            {
                ...
                {
                    EditorGUILayout.HelpBox("The number of toggles should be equivalent to the number of panels. There are currently " + numberOfToggles + " toggles and " + numberOfPanels + " panels.", MessageType.Warning);
                }
                EditorGUI.indentLevel--;
            }
        }
        ...
        {
            EditorGUILayout.PropertyField(thresholdSnappingSpeed, new GUIContent("Threshold Snap Speed", "The speed at which the ScrollRect will stop scrolling and begin snapping to the targeted panel."));
        }
